...
<div className="max-w-[85rem] px-4 xl:px-0 py-10 lg:pt-14 lg:pb-14 mx-auto">

  <div className=" text-center mb-10 lg:mb-14">
    <h2 className="text-2xl font-bold md:text-4xl md:leading-tight text-foreground text-left">Our leadership</h2>
    <p className="mt-1 text-muted-foreground-2 text-left">Creative people</p>
  </div>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    <div className="flex flex-col rounded-xl p-4 md:p-6  bg-base-300">
      ...
      <div className="mt-3 space-x-1">
        <a className="inline-flex justify-center items-center size-8 text-sm font-semibold rounded-lg bg-layer border border-layer-line text-muted-foreground-1 hover:bg-muted-hover focus:outline-hidden focus:bg-muted-focus disabled:opacity-50 disabled:pointer-events-none" href="#">
