...
<footer className="mt-auto w-full py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-base-300">
  <div className="text-center">
    ...
    <div className="mt-3">
      <p className="text-muted-foreground-1"> Secure shopping. Fast delivery. Easy returns.</p>
    ...
    <div className="mt-3 space-x-2">
      <a className="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full text-muted-foreground-1 hover:bg-muted-hover focus:outline-hidden focus:bg-muted-focus disabled:opacity-50 disabled:pointer-events-none" href="#">
